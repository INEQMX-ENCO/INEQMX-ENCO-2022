...
df_enco = pd.read_csv('data/interim/enco/enco_interim_tidy.csv')  # Replace with the correct interim file
...
profile_enco_ydata.to_file('docs/assets/interim_enco_profiling_report.html')

print("YData profiling report for ENCO saved to docs/assets/interim_enco_profiling_report.html")
...
df_enigh = pd.read_csv('data/interim/enigh/enigh_tidy_data.csv')  # Replace with the correct interim file

# Generate the profiling report using ydata-profiling
profile_enigh_ydata = ProfileReport(df_enigh, title="ENIGH YData Profiling Report", explorative=True)

# Save the ydata-profiling report to the MkDocs 'docs/assets/' directory
profile_enigh_ydata.to_file('docs/assets/interim_enigh_profiling_report.html')

print("YData profiling report for ENIGH saved to docs/assets/interim_enigh_profiling_report.html")
...
print("Sweetviz report for ENIGH saved to docs/assets/interim_enigh_sweetviz_report.html")
